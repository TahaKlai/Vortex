 ...
 */
class getFrontRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FrontRepository' shared autowired service.
     *
     * @return \App\Repository\FrontRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FrontRepository.php';

        return $container->privates['App\\Repository\\FrontRepository'] = new \App\Repository\FrontRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
